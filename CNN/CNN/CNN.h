...
class CNN {
	public:
		...
		vector<vector<vector<float>>> conv(vector<vector<vector<float>>> img, vector<vector<vector<float>>> conv_filter);
		...
		void setL2_filter(vector<vector<vector<float>>> value);
		vector<vector<vector<float>>> getL2_filter();
		...
		void setL3_filter(vector<vector<vector<float>>> value);
		vector<vector<vector<float>>> getL3_filter();
...
private:
		...
		vector<vector<vector<float>>> l2_filter;
		...
		vector<vector<vector<float>>> l3_filter;
